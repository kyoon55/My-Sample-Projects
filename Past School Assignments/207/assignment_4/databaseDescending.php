...
<div class = "studentName">
    ...
    <div class="content">
        ...
        ?>
        <h1>Comments Descending Order (Z to A)</h1>
        <?php
        ...
        $query = mysql_query("select * from comment order by name desc");
        $resultCopy = array();
        ...
        $_SESSION['accountCopy'] = $resultCopy;
                    ...
                    */
                    ...
                    $insertCopy = "INSERT INTO commentCopy (`name`,`email`, `comment`) SELECT `name`,`email`, `comment` FROM comment order by name desc";
